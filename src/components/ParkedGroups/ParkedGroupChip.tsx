...
export default function ParkedGroupChip({ group, onInclude, onFight, onRemove }: Props) {
	return (
		<div
		...
		>
			...
			<button onClick={() => onFight(group)} className="text-lime-400 hover:text-lime-300 text-sm">Fight</button>
