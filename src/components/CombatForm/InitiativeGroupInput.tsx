  ...
  return (
    <div className="flex flex-col gap-2 p-2 bg-slate-900 rounded border border-slate-600">
      ...
      <div className="flex items-center gap-2">
        <span className="text-xs text-slate-400 font-semibold min-w-[24px] flex-shrink-0">#{index + 1}</span>
      ...
      <div className="flex items-center gap-2 min-w-0">
        ...
        <button
          ...
          disabled={!canRemove}
          className={`px-3 py-2 rounded transition flex-shrink-0 ${canRemove
